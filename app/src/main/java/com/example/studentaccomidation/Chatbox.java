...
public class Chatbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatbox); // Use chatbox.xml layout instead of activity_main
        ...
        sendQueryButton.setOnClickListener(v -> {
            ...
            model.getResponse(query, new ResponseCallback() {
                ...
                public void onError(Throwable throwable) {
                    Toast.makeText(Chatbox.this,"Error:" + throwable.getMessage(),Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            });
        });
