...
public class GeminiPro extends AppCompatActivity {
    ...
    private GenerativeModelFutures getmodel() {
        ...
        GenerationConfig.Builder configureBuilder = new GenerationConfig.Builder();
        configureBuilder.temperature = 0.9f;
        configureBuilder.topK = 16;
        configureBuilder.topP= 0.1f;
        GenerationConfig generationConfig = configureBuilder.build();

        GenerativeModel gm = new GenerativeModel(
                "gemini-pro",apiKey,generationConfig, Collections.singletonList(harassmentSafety)
        );
